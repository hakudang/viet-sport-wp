<?php
/**
 * File: parts/top/post_slider.php
 * Mục đích: Load các header slider
 */
if ( ! defined( 'ABSPATH' ) ) exit;

$SETTING = SWELL_Theme::get_setting();
$q_args  = [
	'post_type'           => ['post', 'sport_team'], // ← カスタム投稿 sport_team を対象に追加
	'post_status'         => 'publish',
	'no_found_rows'       => true,
	'posts_per_page'      => 8,
...
// Thêm tax_query để lọc bài viết theo taxonomy sport_team_category và value="women"
// ← Phần này đã được thêm vào để lọc theo taxonomy 'sport_team_category' và term 'women'

$q_args['tax_query'] = [
    [
        'taxonomy' => 'sport_team_status',
        'field'    => 'slug', // Hoặc 'term_id' nếu bạn muốn dùng ID của term
        'terms'    => 'on', // ← Đây là giá trị "on" bạn muốn lọc
        'operator' => 'IN', // Lọc theo term 'on'
    ]
];
