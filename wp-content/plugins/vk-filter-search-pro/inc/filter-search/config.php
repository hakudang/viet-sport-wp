...
if (
	! class_exists( 'VK_Filter_Search' ) &&
	! class_exists( 'VK_Filter_Search_Block' ) &&
	! class_exists( 'VK_Filter_Search_Shortcode' ) &&
	! class_exists( 'VK_Filter_Search_Title' )
) {
	...
	// 読み込むファイルを調整.
	require_once __DIR__ . '/package/class-vk-filter-search.php';
	require_once __DIR__ . '/package/class-vk-filter-search-block.php';
	require_once __DIR__ . '/package/class-vk-filter-search-shortcode.php';
	require_once __DIR__ . '/package/class-vk-filter-search-title.php';
}
...
if ( ! function_exists( 'vkfs_set_script_translations' ) ) {
	...
	function vkfs_set_script_translations() {
		if ( function_exists( 'wp_set_script_translations' ) ) {
			wp_set_script_translations( 'vk-filter-search-block', 'vk-filter-search-pro', VKFS_PLUGIN_ROOT_PATH . '/languages/' );
		}
	}
