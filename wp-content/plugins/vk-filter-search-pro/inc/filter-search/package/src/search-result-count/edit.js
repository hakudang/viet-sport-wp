...
export default function SearchResultEdit( props ) {
	...
	*/
	const FONT_STYLES = [
		{
			label: __( 'Regular', 'vk-filter-search-pro' ),
			value: 'normal',
		},
		{
			label: __( 'Italic', 'vk-filter-search-pro' ),
			value: 'italic',
		},
		{
			label: __( 'Oblique', 'vk-filter-search-pro' ),
			value: 'oblique',
		},
	];
	/*
	...
	*/
	const FONT_WEIGHTS = [
		{
			label: __( 'Thin (100)', 'vk-filter-search-pro' ),
			value: '100',
		},
		{
			label: __( 'Extra Light (200)', 'vk-filter-search-pro' ),
			value: '200',
		},
		{
			label: __( 'Light (300)', 'vk-filter-search-pro' ),
			value: '300',
		},
		{
			label: __( 'Regular (400)', 'vk-filter-search-pro' ),
			value: '400',
		},
		{
			label: __( 'Medium (500)', 'vk-filter-search-pro' ),
			value: '500',
		},
		{
			label: __( 'Semi Bold (600)', 'vk-filter-search-pro' ),
			value: '600',
		},
		{
			label: __( 'Bold (700)', 'vk-filter-search-pro' ),
			value: '700',
		},
		{
			label: __( 'Extra Bold (800)', 'vk-filter-search-pro' ),
			value: '800',
		},
		{
			label: __( 'Black (900)', 'vk-filter-search-pro' ),
			value: '900',
		},
		{
			label: __( 'Extra Black (1000)', 'vk-filter-search-pro' ),
			value: '1000',
		},
	];
			...
			<InspectorControls>
				...
				>
					...
					<BaseControl id={ 'vkfs-pro-numberFontStyle' }>
						<SelectControl
							label={ __( 'Font Style', 'vk-filter-search-pro' ) }
					...
					<BaseControl
						...
						label={ __( 'Text Color', 'vk-filter-search-pro' ) }
					>
						<AdvancedColorPalette
							schema={ 'numberColor' }
							{ ...props }
